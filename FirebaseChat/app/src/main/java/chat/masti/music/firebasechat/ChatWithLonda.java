...
public class ChatWithLonda extends AppCompatActivity {
    ...
    ChatWithLondaAdapter chatWithLondaAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chatWithLondaAdapter = new ChatWithLondaAdapter(chatMessages);
